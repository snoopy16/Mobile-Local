    ...
    $.getJSON(yqlgooglegeocodeurl, function(data){
      ...
      */
       ...
       */
       ...
       /* $("#weather").empty();
                    zip2=zip.split(/ /).join("%20");
                    //alert(zip2);

                var xyz="http://www.worldweatheronline.com/feed/weather.ashx?key=1ffe4f176c013028111302&q=" + zip2 +"&includeLocation=yes&format=json&callback=?";*/

        userinput = $("#anylocationinput").val().split(", ").join("%20")
        

      
       var weathernewsurl = 'http://free.worldweatheronline.com/feed/weather.ashx?num_of_days=5&key=1ffe4f176c013028111302&q=';
       //var weathernewsurl = "http://www.worldweatheronline.com/feed/weather.ashx?num_of_days=5&key=1ffe4f176c013028111302&q"
       //weathernewsurl += locationlatitude;
       weathernewsurl += userinput
       //weathernewsurl += ',';
       weathernewsurl +="&includeLocation=yes&format=json&callback=?"
       alert(weathernewsurl)
       
       //Working URL - http://free.worldweatheronline.com/feed/weather.ashx?key=1ffe4f176c013028111302&q=Boston%20MA%20USA&includeLocation=yes&format=json&callback=?
...
longitude for a uniform query input and result set */
    ...
    // Bind the onclick event to simply alert the
      ...
      $( this ).bind ( "click", function(){ alert( "Click Index: " + intIndex );      }      );
